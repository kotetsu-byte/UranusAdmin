            ...
            builder.Entity<Lesson>()
                .HasData(
                    ...
                    new Lesson
                    {
                        ...
                        CourseId = 1,
                        Title = "Lesson 4",
                        Content = "Combining like terms means to simplify an algebraic expression by counting the variables that are the same. Simply look at each letter in turn and add the numbers in front of them to see how many there are in total.",
                    },
                    new Lesson
                    {
                        Id = 5,
                        CourseId = 1,
                        Title = "Lesson 5",
                        Content = "Distributive property is the algebraic property used to multiply a number with the sum or difference of two or more numbers within a parenthesis. We can say that the distributive property helps in simplifying the problems by breaking the expressions into addition or subtraction of products or vice versa.",
                    },
                    new Lesson
                    {
                        Id = 6,
                    ...
                    new Lesson
                    {
                        ...
                        CourseId = 2,
                        Title = "Lesson 2",
                        Content = "Distance is the measurement of paths taken by an object. In simple words, distance is something an object covers in a given time ‘t. ‘ However, displacement is the shortest path taken by an object during its motion. Distance and displacement are two physical quantities that we use in our everyday life.",
                    },
                    new Lesson
                    {
                        Id = 9,
                    ...
                    new Lesson
                    {
                        ...
                        CourseId = 2,
                        Title = "Lesson 5",
                        Content = "In mechanics, acceleration is the rate of change of the velocity of an object with respect to time. Acceleration is one of several components of kinematics, the study of motion. Accelerations are vector quantities (in that they have magnitude and direction). The orientation of an object's acceleration is given by the orientation of the net force acting on that object.",
                    },
                    new Lesson
                    {
                        Id = 12,
                    ...
                    new Lesson
                    {
                        ...
                        CourseId = 3,
                        Title = "Lesson 1",
                        Content = "The average atomic mass (sometimes called atomic weight) of an element is the weighted average mass of the atoms in a naturally occurring sample of the element. Average masses are generally expressed in unified atomic mass units (u), where 1 u is equal to exactly one-twelfth the mass of a neutral atom of carbon-12. Created by Sal Khan. So the atomic mass unit is 1/12th the mass of carbon-12.",
                    },
                    new Lesson
                    {
                        Id = 14,
                    ...
                    new Lesson
                    {
                        ...
                        CourseId = 3,
                        Title = "Lesson 3",
                        Content = "There are three main types of chemical formulas: empirical, molecular and structural. Empirical formulas show the simplest whole-number ratio of atoms in a compound, molecular formulas show the number of each type of atom in a molecule, and structural formulas show how the atoms in a molecule are bonded to each other.",
                    },
                    new Lesson
                    {
                        Id = 16,
                        CourseId = 3,
                        Title = "Lesson 4",
                        Content = "Elemental analysis can be used to determine the amounts of substances in a mixture. For example, if elemental analysis tells us that a potassium supplement contains 22% K by mass, and we know that the K is present as KCl, we can calculate the grams of KCl in the supplement.",
                    },
                    new Lesson
                    {
                        Id = 17,
                        CourseId = 3,
                        Title = "Lesson 5",
                        Content = "The main difference between shell subshell and orbital is that shells are composed of electrons that share the same principal quantum number and subshells are composed of electrons that share the same angular momentum quantum number whereas orbitals are composed of electrons that are in the same energy level but have different spins.",
                    },
                    new Lesson
                    {
                        Id = 18,
                    ...
                    new Lesson
                    {
                        ...
                        CourseId = 4,
                        Title = "Lesson 3",
                        Content = "The hydrogen bonding in water is a vigorous bond between the nearest water molecule containing one Hydrogen atom between two oxygen atoms. Hydrogen bonding is major of two types of intramolecular and intermolecular hydrogen bonding, on the basis of the atoms involved in it. Hydrogen bonding is maximum in solid-state compounds.",
                    },
                    new Lesson
                    {
                        Id = 22,
            ...
            builder.Entity<Video>()
                .HasData(
                    ...
                    new Video
                    {
                        ...
                        VideoName = "What is a variable.mp4"
                    },
                    new Video
                    {
                        Id = 2,
                        ...
                        VideoName = "How to evaluate expressions with two variables.mp4"
                    },
                    new Video
                    {
                        Id = 3,
                        ...
                        VideoName = "How to write basic expressions with variables.mp4"
                    },
                    new Video
                    {
                        Id = 4,
                        ...
                        VideoName = "Combining like terms introduction.mp4"
                    },
                    new Video
                    {
                        Id = 5,
                        ...
                        VideoName = "How to use the distributive property with variables.mp4"
                    },
                    new Video
                    {
                        Id = 6,
                        ...
                        VideoName = "How to find equivalent expressions by combining like terms.mp4"
                    },
                    // Physics
                    new Video
                    {
                        ...
                        VideoName = "Introduction to physics.mp4"
                    },
                    new Video
                    {
                        Id = 8,
                        ...
                        VideoName = "Distance and displacement introduction.mp4"
                    },
                    new Video
                    {
                        Id = 9,
                        ...
                        VideoName = "Average velocity and speed worked example.mp4"
                    },
                    new Video
                    {
                        Id = 10,
                        ...
                        VideoName = "Instantaneous speed and velocity.mp4"
                    },
                    new Video
                    {
                        Id = 11,
                    ...
                    new Video
                    {
                        ...
                        VideoName = "Choosing kinematic equations.mp4"
                    },
                    // Chemistry
                    new Video
                    {
                        ...
                        VideoName = "Average atomic mass.mp4"
                    },
                    new Video
                    {
                        Id = 14,
                    ...
                    new Video
                    {
                        ...
                        VideoName = "Empirical, molecular, and structural formulas.mp4"
                    },
                    new Video
                    {
                        Id = 16,
                        ...
                        VideoName = "Calculating the mass of a substance in a mixture.mp4"
                    },
                    new Video
                    {
                        Id = 17,
                        ...
                        VideoName = "Shells, subshells, and orbitals.mp4"
                    },
                    new Video
                    {
                        Id = 18,
                        ...
                        VideoName = "Periodic trends and Coulomb's law.mp4"
                    },
                    // Biology
                    new Video
                    {
                        ...
                        VideoName = "Biology overview.mp4"
                    },
                    new Video
                    {
                        Id = 20,
                        ...
                        VideoName = "Elements and atoms.mp4"
                    },
                    new Video
                    {
                        Id = 21,
                        ...
                        VideoName = "Hydrogen bonding in water.mp4"
                    },
                    new Video
                    {
                        Id = 22,
                        ...
                        VideoName = "Introduction to pH.mp4"
                    },
                    new Video
                    {
                        Id = 23,
                    ...
                    new Video
                    {
                        ...
                        VideoName = "Introduction to the cell.mp4"
                    },
                    // Informatics
                    new Video
                    {
