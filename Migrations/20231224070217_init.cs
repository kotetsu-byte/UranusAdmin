    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "In mathematics, a variable (from Latin variabilis, \"changeable\") is a symbol that represents a mathematical object. A variable may represent a number, a vector, a matrix, a function, the argument of a function, a set, or an element of a set.\r\n\r\nAlgebraic computations with variables as if they were explicit numbers solve a range of problems in a single computation. For example, the quadratic formula solves any quadratic equation by substituting the numeric values of the coefficients of that equation for the variables that represent them in the quadratic formula. In mathematical logic, a variable is either a symbol representing an unspecified term of the theory (a meta-variable), or a basic object of the theory that is manipulated without referring to its possible intuitive interpretation.", 1, "Lesson 1" },
                    { 2, "There are many methods for solving a system of linear equation, one of them is elimination method.\r\n\r\nAs the name suggest in elimination method, we eliminate one of the variables by subtracting one equation from another (or first multiplying one of the equation with some number and then subtracting from other equation).", 1, "Lesson 2" },
                    { 3, "Terms in an algebraic expression are separated by addition operators and factors are separated by multiplication operators. The numerical factor of a term is called the coefficient. For example, the algebraic expression x2y2+6xy−3\r\n can be thought of as  x2y2+6xy+(−3)\r\n and has three terms. The first term, x2y2\r\n, represents the quantity  1x2y2=1⋅x⋅x⋅y⋅y\r\n where 1 is the coefficient and x and y are the variables. All of the variable factors with their exponents form the variable part of a term.", 1, "Lesson 3" },
                    { 4, "Combining like terms means to simplify an algebraic expression by counting the variables that are the same. Simply look at each letter in turn and add the numbers in front of them to see how many there are in total.", 1, "Lesson 4" },
                    { 5, "Distributive property is the algebraic property used to multiply a number with the sum or difference of two or more numbers within a parenthesis. We can say that the distributive property helps in simplifying the problems by breaking the expressions into addition or subtraction of products or vice versa.", 1, "Lesson 5" },
                    { 6, "In order to understand what “combining like terms” means, let’s get some basic definitions out of the way. First, we have to understand the concept of a term. In algebra, a term can be a number, variable, or product (the multiplication) of a number and variable. Recall, a variable can represent any possible number. Typically in algebra, we use symbols like x or y to represent variables.", 1, "Lesson 6" },
                    { 7, "The physical universe is enormously complex in its detail. Every day, each of us observes a great variety of objects and phenomena. Over the centuries, the curiosity of the human race has led us collectively to explore and catalog a tremendous wealth of information. From the flight of birds to the colors of flowers, from lightning to gravity, from quarks to clusters of galaxies, from the flow of time to the mystery of the creation of the universe, we have asked questions and assembled huge arrays of facts. In the face of all these details, we have discovered that a surprisingly small and unified set of physical laws can explain what we observe. As humans, we make generalizations and seek order. We have found that nature is remarkably cooperative—it exhibits the underlying order and simplicity we so value.", 2, "Lesson 1" },
                    { 8, "Distance is the measurement of paths taken by an object. In simple words, distance is something an object covers in a given time ‘t. ‘ However, displacement is the shortest path taken by an object during its motion. Distance and displacement are two physical quantities that we use in our everyday life.", 2, "Lesson 2" },
                    { 9, "Average speed is a rate that is a quantity divided by the time taken to get that quantity. SI unit of speed is meters per second. Average speed is calculated by the formula S = d/t, where S equals the average speed, d equals total distance and t equals total time. Average Velocity. Average velocity of an object can be defined as the displacement with regards to the original position divided by the time.", 2, "Lesson 3" },
                    { 10, "The instantaneous speed is the speed of an object at a particular moment in time. And if you include the direction with that speed, you get the instantaneous velocity. In other words, eight meters per second to the right was the instantaneously velocity of this person at that particular moment in time.", 2, "Lesson 4" },
                    { 11, "In mechanics, acceleration is the rate of change of the velocity of an object with respect to time. Acceleration is one of several components of kinematics, the study of motion. Accelerations are vector quantities (in that they have magnitude and direction). The orientation of an object's acceleration is given by the orientation of the net force acting on that object.", 2, "Lesson 5" },
                    ...
                    { 13, "The average atomic mass (sometimes called atomic weight) of an element is the weighted average mass of the atoms in a naturally occurring sample of the element. Average masses are generally expressed in unified atomic mass units (u), where 1 u is equal to exactly one-twelfth the mass of a neutral atom of carbon-12. Created by Sal Khan. So the atomic mass unit is 1/12th the mass of carbon-12.", 3, "Lesson 1" },
                    { 14, "Isotopes are two or more types of chemical species or elements that are having same atomic number and the same position in the periodic table of elements. isotopes have different mass numbers or nucleon numbers due to the difference in the number of neutrons in their nuclei. However, all isotopes of a particular element have almost the same chemical properties and different atomic masses, and physical properties.", 3, "Lesson 2" },
                    { 15, "There are three main types of chemical formulas: empirical, molecular and structural. Empirical formulas show the simplest whole-number ratio of atoms in a compound, molecular formulas show the number of each type of atom in a molecule, and structural formulas show how the atoms in a molecule are bonded to each other.", 3, "Lesson 3" },
                    { 16, "Elemental analysis can be used to determine the amounts of substances in a mixture. For example, if elemental analysis tells us that a potassium supplement contains 22% K by mass, and we know that the K is present as KCl, we can calculate the grams of KCl in the supplement.", 3, "Lesson 4" },
                    { 17, "The main difference between shell subshell and orbital is that shells are composed of electrons that share the same principal quantum number and subshells are composed of electrons that share the same angular momentum quantum number whereas orbitals are composed of electrons that are in the same energy level but have different spins.", 3, "Lesson 5" },
                    { 18, "Periodic trends are specific patterns that are present in the periodic table that illustrate different aspects of a certain element. They were discovered by the Russian chemist Dmitri Mendeleev in the year 1863. Major periodic trends include atomic radius, ionization energy, electron affinity, electronegativity, valency and metallic character.", 3, "Lesson 6" },
                    { 19, "Biology is the branch of science that primarily deals with the structure, function, growth, evolution, and distribution of organisms. As a science, it is a methodological study of life and living things. It determines verifiable facts or formulates theories based on experimental findings on living things by applying the scientific method. An expert in this field is called a biologist.", 4, "Lesson 1" },
                    { 20, "Difference between Elements and Atoms is that Elements are made from atoms and atoms are the smallest part of elements. Elements are the simplest form of any substance and. Atoms are the simplest unit of matter. An element cannot be further broken down by chemical reactions into simpler substances. Elements are made of atoms that have the same atomic number i.e. the nucleus contains the same number of protons.", 4, "Lesson 2" },
                    { 21, "The hydrogen bonding in water is a vigorous bond between the nearest water molecule containing one Hydrogen atom between two oxygen atoms. Hydrogen bonding is major of two types of intramolecular and intermolecular hydrogen bonding, on the basis of the atoms involved in it. Hydrogen bonding is maximum in solid-state compounds.", 4, "Lesson 3" },
                    { 22, "The term “pH” is an abbreviation for the “potential of hydrogen.” pH is a unit of measurement that represents the concentration of hydrogen ions in a solution. This unit was introduced by biochemist Søren Peter Lauritz Sørensen in 1909. It was an easy way to represent the concentration of hydrogen ions in a solution during titrations. When an acid or base is added to water, that compound dissociates into ions.", 4, "Lesson 4" },
                    { 23, "The smallest objects that the unaided human eye can see are about 0.1 mm long. That means that under the right conditions, you might be able to see an amoeba proteus, a human egg, and a paramecium without using magnification. A magnifying glass can help you to see them more clearly, but they will still look tiny.", 4, "Lesson 5" },
                    { 24, "The human body is made up of “just” 200–400 cell types, but we (i.e. you and I) have copious amount of each cell types. In fact, there is a mind-bogglingly 10¹⁴ cells (that’s 100 trillion of cells) in a human body, organized into tissues and organs that give rise to life. Cells come in thousands of shapes and sizes, but they are so small that 10,000 of our cells could all fit on the head of a pin. To sustain life, the cells in our body go through 5 x 10¹⁷ biochemical reactions per second (that’s 500 quadrillion every second!). That is why biochemistry plays such a crucial role in understanding cells (and life) and has important medical applications.", 4, "Lesson 6" },
                    { 25, "", 5, "Lesson 1" },
                    { 26, "", 5, "Lesson 2" },
                    { 27, "", 5, "Lesson 3" },
                    { 28, "", 5, "Lesson 4" },
            ...
            migrationBuilder.InsertData(
                table: "Docs",
                columns: new[] { "Id", "CourseId", "DocName", "LessonId", "Title" },
                values: new object[,]
                {
                    { 1, 1, "", 1, "" },
                    { 2, 1, "", 2, "" },
            ...
            migrationBuilder.InsertData(
                table: "Homeworks",
                columns: new[] { "Id", "CourseId", "Deadline", "Description", "LessonId", "Title" },
                values: new object[,]
                {
                    { 1, 1, new DateOnly(2024, 5, 5), "", 1, "Homework 1" },
                    { 2, 1, new DateOnly(2024, 5, 5), "", 2, "Homework 1" },
                    { 3, 1, new DateOnly(2024, 5, 5), "", 3, "Homework 1" },
                    { 4, 1, new DateOnly(2024, 5, 5), "", 4, "Homework 1" },
                    { 5, 1, new DateOnly(2024, 5, 5), "", 5, "Homework 1" },
                    { 6, 1, new DateOnly(2024, 5, 5), "", 6, "Homework 1" },
                    { 7, 2, new DateOnly(2024, 5, 5), "", 7, "Homework 1" },
                    { 8, 2, new DateOnly(2024, 5, 5), "", 8, "Homework 1" },
                    { 9, 2, new DateOnly(2024, 5, 5), "", 9, "Homework 1" },
                    { 10, 2, new DateOnly(2024, 5, 5), "", 10, "Homework 1" },
                    { 11, 2, new DateOnly(2024, 5, 5), "", 11, "Homework 1" },
                    { 12, 2, new DateOnly(2024, 5, 5), "", 12, "Homework 1" },
                    { 13, 3, new DateOnly(2024, 5, 5), "", 13, "Homework 1" },
                    { 14, 3, new DateOnly(2024, 5, 5), "", 14, "Homework 1" },
                    { 15, 3, new DateOnly(2024, 5, 5), "", 15, "Homework 1" },
                    { 16, 3, new DateOnly(2024, 5, 5), "", 16, "Homework 1" },
                    { 17, 3, new DateOnly(2024, 5, 5), "", 17, "Homework 1" },
                    { 18, 3, new DateOnly(2024, 5, 5), "", 18, "Homework 1" },
                    { 19, 4, new DateOnly(2024, 5, 5), "", 19, "Homework 1" },
                    { 20, 4, new DateOnly(2024, 5, 5), "", 20, "Homework 1" },
                    { 21, 4, new DateOnly(2024, 5, 5), "", 21, "Homework 1" },
                    { 22, 4, new DateOnly(2024, 5, 5), "", 22, "Homework 1" },
                    { 23, 4, new DateOnly(2024, 5, 5), "", 23, "Homework 1" },
                    { 24, 4, new DateOnly(2024, 5, 5), "", 24, "Homework 1" },
                    { 25, 5, new DateOnly(2024, 5, 5), "", 25, "Homework 1" },
                    { 26, 5, new DateOnly(2024, 5, 5), "", 26, "Homework 1" },
                    { 27, 5, new DateOnly(2024, 5, 5), "", 27, "Homework 1" },
                    { 28, 5, new DateOnly(2024, 5, 5), "", 28, "Homework 1" },
                    { 29, 5, new DateOnly(2024, 5, 5), "", 29, "Homework 1" },
                    { 30, 5, new DateOnly(2024, 5, 5), "", 30, "Homework 1" }
                });

            migrationBuilder.InsertData(
                table: "Videos",
                columns: new[] { "Id", "CourseId", "LessonId", "Title", "VideoName" },
                values: new object[,]
                {
            ...
            migrationBuilder.InsertData(
                table: "Materials",
                columns: new[] { "Id", "CourseId", "HomeworkId", "LessonId", "MaterialName", "Title" },
                values: new object[,]
                {
                    { 1, 1, 1, 1, "", "" },
                    { 2, 1, 2, 2, "", "" },
